...
> Wav2Lip：可以把视频中人物说话口型，替换成音频中的口型

```python
# 执行下面的命令将视频 test.mp4 和音频 test.mp3 进行合成
python inference.py --checkpoint_path wav2lip_gan.pth --face .\tg\1.mp4 --audio .\tg\1.mp3
...
参考文章：https://blog.csdn.net/m0_46825740/article/details/125973050
